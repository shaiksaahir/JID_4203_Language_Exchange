...
Below is an example implementation of the translation logic into a javascript program

```js
import translate from "translate";

translate.engine = "deepl"; // if translation engine is not specificed, the goodle translation engine is used.
translate.key = process.env.DEEPL_KEY; // no key is needed for default google engine
...
translate.key = process.env.DEEPL_KEY; // for DeepL or Yandex
```
