...
The following is an example implementation of this translation package into a js component

```js
import translate from "translate";

translate.engine = "deepl"; 
translate.key = process.env.DEEPL_KEY; // for DeepL and Yandex, an API key is required
